...
## Building or Migrating an Application on Arm

- Deciding to build new or migrate existing applications: **Part 3 Section 2.1 - Migration Overview**
- Optimizing Performance: **Part 3 Section 9 - Performance Analysis and Optimization**
